...
<!-- Mirrored from altair_html.tzdthemes.com/login_v2.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 20 Apr 2018 06:27:34 GMT -->
<head>
    <meta charset="UTF-8">
    ...
    <title>Aurora Admin v2.13.0 - Login Page v2</title>

    <link href='fonts.googleapis.com/css7dfd.css?family=Roboto:300,400,500' rel='stylesheet' type='text/css'>
                    ...
                    <div class="uk-width-large-2-3 uk-hidden-medium uk-hidden-small">
                        <div class="login_page_info uk-height-1-1" style="background-image: url('assets/img/others/sabri-tuzcu-331970.jpg')">
                            <div class="info_content">
                                <h1 class="heading_b">Aurora DevOps</h1>
                        ...
                        <div class="login_page_forms">
                            <div id="login_card">
                                <div id="login_form">
                                    ...
                                    <form>
                                        ...
                                        <div class="uk-margin-medium-top">
                                            <a onclick="login.checkLoginDetails();" class="md-btn md-btn-primary md-btn-block md-btn-large">Sign In</a>
                                        </div>
                                ...
                                <div class="uk-position-relative" id="login_help" style="display: none">
                                    ...
                                    <p>Here is the info to get you back in to your account as quickly as possible.</p>
                                    <p>First, try the easiest thing: if you remember your password but it is not working, make sure that Caps Lock is turned off, and that your username is spelled correctly, and then try again.</p>
                                    <p>If your password still is not working, it is time to <a href="#" id="password_reset_show">reset your password</a>.</p>
                                </div>
...
<!-- Mirrored from altair_html.tzdthemes.com/login_v2.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 20 Apr 2018 06:27:35 GMT -->
</html>