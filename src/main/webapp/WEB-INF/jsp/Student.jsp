...
<!-- Mirrored from altair_html.tzdthemes.com/forms_wizard.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 20 Apr 2018 06:27:49 GMT -->
<head>
    <meta charset="UTF-8">
                            ...
                            <div class="uk-width-2-3">
                                <div class="uk-grid uk-grid-width-medium-1-3 uk-margin-bottom uk-text-center">
                                    ...
                                    <a href="page_user_profile.html" class="uk-margin-top">
                                        ...
                                        <span class="uk-text-muted uk-display-block">Your Profile</span>
                                    </a>
                                </div>
                            </div>
                            <div class="uk-width-1-3">
                                <ul class="uk-nav uk-nav-dropdown uk-panel">
                                    <li class="uk-nav-header">Quick Navigate</li>
                                    <li><a href="components_accordion.html">Students</a></li>
                                    <li><a href="components_buttons.html">Invoices</a></li>
                                    <li><a href="components_notifications.html">Vehicles</a></li>
                                    <li><a href="components_sortable.html">Teachers</a></li>
    ...
    <div class="menu_section">
        <ul>
            ...
            <li title="Students">
                ...
                <ul>
                    <li><a href="/student"><span class="submenu-icon"><i
                            class="uk-icon-spinner uk-icon-medium uk-icon-spin"></i></span> New Student</a></li>
                    <li><a href="forms_advanced.html"><span class="submenu-icon"><i
                            class="uk-icon-spinner uk-icon-medium uk-icon-spin"></i></span> Payment History</a></li>
                    <li><a href="forms_advanced.html"><span class="submenu-icon"><i
                            class="uk-icon-spinner uk-icon-medium uk-icon-spin"></i></span> All Student</a></li>
                </ul>
            </li>
            <li title="Tutors">
                <a href="page_user_profile.html">
                    <span class="menu_icon"><i class="material-icons">&#xE85E;</i></span>
                    <span class="menu_title">Tutors</span>
                </a>
                <ul>
                    <li><a href="forms_advanced.html"><span class="submenu-icon"><i
                            class="uk-icon-spinner uk-icon-medium uk-icon-spin"></i></span> New Tutor</a></li>
                    <li><a href="forms_advanced.html"><span class="submenu-icon"><i
                            class="uk-icon-spinner uk-icon-medium uk-icon-spin"></i></span> All Tutors</a></li>
                </ul>
            </li>
            <li title="Invoices">
            ...
            <li title="Chats">
                ...
                <ul>
                    ...
                    <li><a href="page_chat_small.html">Private Chat Rooms</a></li>
                </ul>
            ...
            <li title="Sticky Notes">
                <a href="page_sticky_notes.html">
                    <span class="menu_icon"><i class="material-icons">&#xE8F0;</i></span>
                    <span class="menu_title">Public Notice Board</span>
                </a>
            ...
            <li title="Forms">
                ...
                <ul>
                    ...
                    <li><a href="forms_advanced.html"><span class="submenu-icon"><i
                            class="material-icons md-color-red-600">&#xE031;</i></span>Advanced Elements</a></li>
            ...
            <li title="Layout">
                ...
                <ul>
                    <li><a href="layout_top_menu.html"><span class="submenu-icon"><i
                            class="material-icons md-color-red-600">&#xE031;</i></span>Top Menu</a></li>
            ...
            <li title="Plugins">
                ...
                <ul>
                    ...
                    <li><a href="plugins_gantt_chart.html"><span class="submenu-icon"><i
                            class="material-icons md-color-red-600">&#xE031;</i></span>Gantt Chart</a></li>
            ...
            <li title="Pages">
                ...
                <ul>
                    ...
                    <li><a href="page_gallery_v2.html"><span class="submenu-icon"><i
                            class="material-icons md-color-red-600">&#xE031;</i></span>Gallery v2</a></li>
                    <li><a href="page_help.html">Help/Faq</a></li>
                    <li><a href="login.html">Login Page</a></li>
                    <li><a href="login_v2.html"><span class="submenu-icon"><i class="material-icons md-color-red-600">&#xE031;</i></span>Login
                        Page v2</a></li>
                    <li><a href="page_mailbox_v2.html"><span class="submenu-icon"><i
                            class="material-icons md-color-red-600">&#xE031;</i></span>Mailbox V2</a></li>
...
<div id="page_content">
    <div id="page_content_inner">
        ...
        <h2 class="heading_b uk-margin-bottom">Customer Information Wizard</h2>
                    ...
                    <div id="wizard_advanced">
                        ...
                        <section>
                            <h2 class="heading_a">
                                ...
                                <span class="sub-heading">All fields are required!</span>
                            </h2>
                            <hr class="md-hr"/>
                            <div class="uk-grid">
                                <div class="uk-width-medium-1-1 parsley-row">
                                    <label for="wizard_fullname">Full Name<span class="req">*</span></label>
                                    <input type="text" name="wizard_fullname" id="wizard_fullname" required
                                           class="md-input"/>
                                </div>
                            </div>
                            <div class="uk-grid">
                                <div class="uk-width-medium-1-1 parsley-row">
                                    <label for="wizard_nic">NIC Number<span class="req">*</span></label>
                                    <input type="text" name="wizard_nic" id="wizard_nic" required class="md-input"/>
                                </div>
                            </div>
                            <div class="uk-grid">
                                <div class="uk-width-medium-1-1 parsley-row">
                                    <label for="wizard_address">Address<span class="req">*</span></label>
                                    <input type="text" name="wizard_address" id="wizard_address" required
                                           class="md-input"/>
                                </div>
                            </div>
                            ...
                            <div class="uk-grid" data-uk-grid-margin>
                                <div class="uk-width-medium-1-3 parsley-row">
                                    <label for="wizard_birth">Birth Day<span class="req">*</span></label>
                                    <input type="text" name="wizard_birth" id="wizard_birth" required class="md-input"
                                           data-parsley-date
                                ...
                                <div class="uk-width-medium-1-3 parsley-row">
                                    ...
                                    <span class="icheck-inline">
                                            <input type="radio" name="wizard_status" id="wizard_status_married" required
                                                   class="wizard-icheck" value="married"/>
                                            <label for="wizard_status_married" class="inline-label">Male</label>
                                        </span>
                                    <span class="icheck-inline">
                                            <input type="radio" name="wizard_status" id="wizard_status_single"
                                                   class="wizard-icheck" value="single"/>
                        ...
                        <section>
                            <h2 class="heading_a">
                                Licence and payment information
                                <span class="sub-heading">Please fill out all required fields.</span>
                            </h2>
                            <hr class="md-hr"/>
                            <div class="uk-grid uk-grid-width-large-1-2 uk-grid-width-xlarge-1-4" data-uk-grid-margin>
                                <div class="parsley-row">
                                    <select id="wizard_lisence_type" name="wizard_lisence_type" required
                                            data-md-selectize-delayed>
                                ...
                                <div class="parsley-row">
                                    <label for="wizard_package_price">Package Price<span class="req">*</span></label>
                                    <input type="text" name="wizard_package_price" id="wizard_package_price" required
                                           class="md-input" disabled="disabled" value="Rs. 20.000.00"/>
                                </div>
                                <div class="parsley-row">
                                    <label for="wizard_package_advance">Advance<span
                                            class="req">*</span></label>
                                    <input type="text" name="wizard_package_advance"
                                           id="wizard_package_advance" required class="md-input"/>
                                </div>
                                <div class="parsley-row">
                                    <label for="wizard_next_payment_date">Next Payment Date<span
                                            class="req">*</span></label>
                                    <input type="text" name="wizard_next_payment_date" id="wizard_next_payment_date"
                            ...
                            <div class="uk-grid uk-grid-width-large-1-3 uk-grid-width-xlarge-1-6" data-uk-grid-margin>
                                <div class="parsley-row">
                                    <label for="wizard_payment_states">Payment States</label>
                                    <input type="text" name="wizard_payment_states" id="wizard_payment_states"
                                           class="md-input"/>
                                </div>
                                <div class="parsley-row">
                                    <label for="wizard_balance">Balance<span class="req">*</span></label>
                                    <input type="text" name="wizard_balance" id="wizard_balance" required
                                           class="md-input"/>
                                </div>
                                <div class="parsley-row">
                                    <label for="wizard_vehicle_body">Body Type<span class="req">*</span></label>
                                    <input type="text" name="wizard_vehicle_body" id="wizard_vehicle_body" required
                                           class="md-input"/>
                                </div>
                                <div class="parsley-row">
                                    <label for="wizard_vehicle_axles">Axles</label>
                                    <input type="text" name="wizard_vehicle_axles" id="wizard_vehicle_axles"
                                           class="md-input"/>
                                </div>
                                <div class="parsley-row">
                                    <label for="wizard_vehicle_fuel">Fuel<span class="req">*</span></label>
                                    <input type="text" name="wizard_vehicle_fuel" id="wizard_vehicle_fuel" required
                                           class="md-input"/>
                                </div>
                            </div>
                        </section>
                        ...
                        <section>
                            <h2 class="heading_a">
                                Exam States
                                <span class="sub-heading">Note :- Customer can face to the exam 3 times.</span>
                            </h2>
                            <hr class="md-hr"/>
                            <span class="uk-alert uk-alert-info">first exam states here!</span>
                            <div class="uk-grid" data-uk-grid-margin>
                                <div class="uk-width-medium-2-6 parsley-row">
                                    <label for="wizard_exam_hall">Exam Hall</label>
                                    <input type="text" name="wizard_exam_hall"
                                           id="wizard_exam_hall" required class="md-input"/>
                                </div>
                                <div class="uk-width-medium-1-6 parsley-row">
                                    <label for="wizard_exam_date">Exam Date<span
                                            class="req">*</span></label>
                                    <input type="text" name="wizard_exam_date" id="wizard_exam_date"
                                           required class="md-input" data-parsley-americandate
                                           data-parsley-americandate-message="This value should be a valid date (MM.DD.YYYY)"
                                           data-uk-datepicker="{format:'MM.DD.YYYY'}"/>
                                </div>
                                <div class="uk-width-medium-1-6 parsley-row">
                                    <label for="wizard_marks">Marks<span
                                            class="req">*</span></label>
                                    <input type="text" name="wizard_marks"
                                           id="wizard_marks" required class="md-input"/>
                                </div>
                                <div class="uk-width-medium-1-6 parsley-row">
                                    <label for="wizard_question_count">Question Count<span class="req">*</span></label>
                                    <input type="text" name="wizard_question_count"
                                           id="wizard_question_count" required class="md-input" value="40 Questions" disabled="disabled"/>
                                </div>
                                <div class="uk-width-medium-1-6 parsley-row">
                                    <label for="wizard_result_states">States<span class="req">*</span></label>
                                    <input type="text" name="wizard_result_states"
                                           id="wizard_result_states" required class="md-input"/>
                                </div>
                            </div>
                            <span class="uk-alert uk-alert-info">Second exam states here!</span>
                            <div class="uk-grid" data-uk-grid-margin>
                                <div class="uk-width-medium-2-6 parsley-row">
                                    <label for="wizard_exam_hall2">Exam Hall</label>
                                    <input type="text" name="wizard_exam_hall2"
                                           id="wizard_exam_hall2" required class="md-input"/>
                                </div>
                                <div class="uk-width-medium-1-6 parsley-row">
                                    <label for="wizard_exam_date2">Exam Date<span
                                            class="req">*</span></label>
                                    <input type="text" name="wizard_exam_date2" id="wizard_exam_date2"
                                           required class="md-input" data-parsley-americandate
                                           data-parsley-americandate-message="This value should be a valid date (MM.DD.YYYY)"
                                           data-uk-datepicker="{format:'MM.DD.YYYY'}"/>
                                </div>
                                <div class="uk-width-medium-1-6 parsley-row">
                                    <label for="wizard_marks2">Marks<span
                                            class="req">*</span></label>
                                    <input type="text" name="wizard_marks2"
                                           id="wizard_marks2" required class="md-input"/>
                                </div>
                                <div class="uk-width-medium-1-6 parsley-row">
                                    <label for="wizard_question_count2">Question Count<span class="req">*</span></label>
                                    <input type="text" name="wizard_question_count2"
                                           id="wizard_question_count2" required class="md-input" value="40 Questions" disabled="disabled"/>
                                </div>
                                <div class="uk-width-medium-1-6 parsley-row">
                                    <label for="wizard_result_states2">States<span class="req">*</span></label>
                                    <input type="text" name="wizard_result_states2"
                                           id="wizard_result_states2" required class="md-input"/>
                                </div>
                            </div>
                            <span class="uk-alert uk-alert-info">Third exam states here!</span>
                            <div class="uk-grid" data-uk-grid-margin>
                                <div class="uk-width-medium-2-6 parsley-row">
                                    <label for="wizard_exam_hall3">Exam Hall</label>
                                    <input type="text" name="wizard_exam_hall3"
                                           id="wizard_exam_hall3" required class="md-input"/>
                                </div>
                                <div class="uk-width-medium-1-6 parsley-row">
                                    <label for="wizard_exam_date3">Exam Date<span
                                            class="req">*</span></label>
                                    <input type="text" name="wizard_exam_date3" id="wizard_exam_date3"
                                           required class="md-input" data-parsley-americandate
                                           data-parsley-americandate-message="This value should be a valid date (MM.DD.YYYY)"
                                           data-uk-datepicker="{format:'MM.DD.YYYY'}"/>
                                </div>
                                <div class="uk-width-medium-1-6 parsley-row">
                                    <label for="wizard_marks3">Marks<span
                                            class="req">*</span></label>
                                    <input type="text" name="wizard_marks3"
                                           id="wizard_marks3" required class="md-input"/>
                                </div>
                                <div class="uk-width-medium-1-6 parsley-row">
                                    <label for="wizard_question_count3">Question Count<span class="req">*</span></label>
                                    <input type="text" name="wizard_question_count3"
                                           id="wizard_question_count3" required class="md-input" value="40 Questions" disabled="disabled"/>
                                </div>
                                <div class="uk-width-medium-1-6 parsley-row">
                                    <label for="wizard_result_states3">States<span class="req">*</span></label>
                                    <input type="text" name="wizard_result_states3"
                                           id="wizard_result_states3" required class="md-input"/>
                                </div>
                            </div>
                        </section>
                        ...
                        <section>
                            <h2 class="heading_a">
                                Medical States
                                <span class="sub-heading">Note :- Customer should handover original report to the branch.</span>
                            </h2>
                            <hr class="md-hr"/>
                            <span class="uk-alert uk-alert-info">first exam states here!</span>
                            <div class="uk-grid" data-uk-grid-margin>
