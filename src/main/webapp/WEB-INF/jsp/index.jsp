...
<!-- Mirrored from altair_html.tzdthemes.com/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 20 Apr 2018 06:24:33 GMT -->
<head>
    <meta charset="UTF-8">
    ...
    <title>Aurora Admin v2.13.0</title>
                    ...
                    <div class="md-card-content">
                        ...
                        <div class="md-card-fullscreen-content">
                            ...
                            <p class="uk-margin-large-top uk-margin-small-bottom heading_list uk-text-success">Some
                                Info:</p>
                            <p class="uk-margin-top-remove">Exercitationem dolores nemo aut molestiae voluptate ut nobis
                                vel eveniet nihil praesentium dolore atque qui rerum facere eum nihil dolores blanditiis
                                porro sint deserunt exercitationem voluptates voluptatem voluptatem saepe explicabo qui
                                aut repellat vel dolore sapiente ipsum aut quibusdam assumenda cum libero aut facilis
                                possimus aut ut earum recusandae neque ex quo quia sit non atque et nostrum est aut
                                excepturi quam et quisquam esse ea et mollitia accusamus fugiat suscipit ut explicabo
                                placeat voluptatem amet distinctio tempore a ratione nostrum saepe minima iusto omnis
                                iste quibusdam aut voluptatem consectetur voluptatem neque quae non iste repellat
                                nostrum odio.</p>
                        </div>
                    </div>
                </div>
                            ...
                            <table class="uk-table">
                                ...
                                <tr class="uk-table-middle">
                                    <td class="uk-width-3-10 uk-text-nowrap"><a
                                            href="page_scrum_board.html">ALTR-231</a></td>
                                    <td class="uk-width-2-10 uk-text-nowrap"><span class="uk-badge">In progress</span>
                                    </td>
                                ...
                                <tr class="uk-table-middle">
                                    <td class="uk-width-3-10 uk-text-nowrap"><a href="page_scrum_board.html">ALTR-82</a>
                                    </td>
                                    <td class="uk-width-2-10 uk-text-nowrap"><span class="uk-badge uk-badge-warning">Open</span>
                                    </td>
                                    <td class="uk-width-3-10">
                                ...
                                <tr class="uk-table-middle">
                                    <td class="uk-width-3-10 uk-text-nowrap"><a
                                            href="page_scrum_board.html">ALTR-123</a></td>
                                ...
                                <tr class="uk-table-middle">
                                    <td class="uk-width-3-10 uk-text-nowrap"><a
                                            href="page_scrum_board.html">ALTR-164</a></td>
                                    <td class="uk-width-2-10 uk-text-nowrap"><span class="uk-badge uk-badge-success">Resolved</span>
                                    </td>
                                    <td class="uk-width-3-10">
                ...
                <div class="md-card">
                    <div class="md-card-head md-bg-light-blue-600">
                        ...
                        <h3 class="md-card-head-text uk-text-center md-color-white">
                            Sadye Goldner <span><a href="cdn-cgi/l/email-protection.html" class="__cf_email__"
                                                   data-cfemail="2240504b564c475b151362454f434b4e0c414d4f">[email&#160;protected]</a></span>
                        </h3>
                    </div>
                    <div class="md-card-content">
                        <ul class="md-list md-list-addon">
                            <li>
                                ...
                                <div class="md-list-content">
                                    <span class="md-list-heading"><a href="cdn-cgi/l/email-protection.html"
                                                                     class="__cf_email__"
                                                                     data-cfemail="3a515f4949565f481458485b544955547a435b52555514595557">[email&#160;protected]</a></span>
                ...
                <div class="md-card">
                    <div class="md-card-head md-bg-grey-900">
                        <div class="uk-cover uk-position-relative uk-height-1-1 transform-origin-50" id="video_player">
                            <iframe width="300" height="150" src="about:blank" data-uk-cover frameborder="0"
                                    allowfullscreen style="max-height:100%"></iframe>
                        </div>
                    </div>
                    <div class="md-card-content">
            ...
            <div>
                <div class="md-card">
                    <div class="md-card-head head_background"
                         style="background-image: url('assets/img/gallery/Image17.jpg')">
                        ...
                        <script id="clndr_events_template" type="text/x-handlebars-template">
                            ...
                            <div class="clndr_days">
                                ...
                                <div class="clndr_days_grid">
                                    {{#each days}}
                                    <div class="{{ this.classes }}" {{#if this.id }} id="{{ this.id }}" {{
                                    /if}}>
                                    <span>{{ this.day }}</span>
                                </div>
                                {{/each}}
                                ...
                                <div>
                                    <div class="uk-input-group">
                                        ...
                                        <input class="md-input" type="text" id="clndr_event_date_control"
                                               data-uk-datepicker="{format:'YYYY-MM-DD', minDate: '2018-01-16' }">
                                    </div>
                                </div>
                                <div>
                                    <div class="uk-input-group">
                ...
                <div class="md-card">
                    ...
                    <div class="md-card-content">
                        <ul class="md-list md-list-addon gmap_list" id="map_users_list">
                            <li data-gmap-lat="37.406267" data-gmap-lon="-122.06742" data-gmap-user="Dr. Rod Herman"
                                data-gmap-user-company="Bogan Ltd">
                                <div class="md-list-addon-element">
                                    <img class="md-user-image md-list-addon-avatar"
                                         src="assets/img/avatars/avatar_01_tn.png" alt=""/>
                                </div>
                                <div class="md-list-content">
                            ...
                            <li data-gmap-lat="37.379267" data-gmap-lon="-122.02148" data-gmap-user="Prof. Davin Huels"
                                data-gmap-user-company="Bartoletti LLC">
                                <div class="md-list-addon-element">
                                    <img class="md-user-image md-list-addon-avatar"
                                         src="assets/img/avatars/avatar_02_tn.png" alt=""/>
                                </div>
                            ...
                            <li data-gmap-lat="37.410267" data-gmap-lon="-122.11048" data-gmap-user="Mozell Kris"
                                data-gmap-user-company="Johnson, Wilderman and Gottlieb">
                                <div class="md-list-addon-element">
                                    <img class="md-user-image md-list-addon-avatar"
                                         src="assets/img/avatars/avatar_03_tn.png" alt=""/>
                                </div>
                                <div class="md-list-content">
                            ...
                            <li data-gmap-lat="37.397267" data-gmap-lon="-122.084417" data-gmap-user="Lorna Bednar Jr."
                                data-gmap-user-company="Miller, Haley and Zulauf">
                                <div class="md-list-addon-element">
                                    <img class="md-user-image md-list-addon-avatar"
                                         src="assets/img/avatars/avatar_04_tn.png" alt=""/>
                                </div>
                                <div class="md-list-content">
                            ...
                            <li data-gmap-lat="37.372267" data-gmap-lon="-122.090417"
                                data-gmap-user="Johnson Stoltenberg"
                                data-gmap-user-company="Reynolds, Blanda and Nader">
                                <div class="md-list-addon-element">
                                    <img class="md-user-image md-list-addon-avatar"
            ...
            <li>
                <div class="timeline timeline_small uk-margin-bottom">
                    ...
                    <div class="timeline_item">
                        ...
                        <div class="timeline_content">Deleted post <a href="#"><strong>Est qui est quasi nulla
                            pariatur.</strong></a></div>
                    </div>
                    <div class="timeline_item">
                    ...
                    <div class="timeline_item">
                        ...
                        <div class="timeline_content">
                            ...
                            <div class="timeline_content_addon">
                                <blockquote>
                                    Est quidem et voluptatem qui est repellat nisi suscipit consequatur veniam
                                    perferendis incidunt.&hellip;
                                </blockquote>
                            </div>
                        </div>
                    </div>
...
<!-- Mirrored from altair_html.tzdthemes.com/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 20 Apr 2018 06:25:36 GMT -->
</html>